...
// twoHandPointedShapeStrech: [Frame, Frame] -> Boolean
const twoHandPointedShapeStrech = R.allPass([
...
const createGestureMatcher = viewportController => R.cond([
  ...
  [
    ...
    processFrameWith(
      (hands, frame) => viewportController.zoom(hands, frame),
      [
  ...
  [
    twoHandPointedShapeStrech,
    processFrameWith(
      (hands, frame) => viewportController.fullScreen(hands, frame),
      [
        R.o(bothHands, curframe),
        R.o(M.Just, lastframe)
      ]
